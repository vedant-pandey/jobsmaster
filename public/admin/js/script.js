...
function resumeupload() {
    ...
    var resume = document.getElementById("resumediv");
...
function experiencecheck() {
    var checkBox = document.getElementById("expchk");
    var resume = document.getElementById("experiencediv");
    if (checkBox.checked == true){
        resume.style.display = "block";
    } else {
        resume.style.display = "none";
...
function setInputFilter(textbox, inputFilter) {
  ...
  setInputFilter(document.getElementById("intLimitTextBox"), function(value) {
    return /^\d*$/.test(value) && (value === "" || parseInt(value) <= 25); });